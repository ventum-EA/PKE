...
<template>
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4" @click.self="emit('close')">
        <div class="bg-zinc-900 border border-white/10 rounded-3xl w-full max-w-xl max-h-[90vh] overflow-y-auto shadow-2xl">
            <div class="p-6 border-b border-white/5 flex items-center justify-between">
                <h2 class="text-lg font-black text-white">⬆ Augšupielādēt partiju</h2>
                <button @click="emit('close')" class="text-zinc-500 hover:text-white transition-colors text-xl">✕</button>
            </div>
